...
const API_BASE_URL = 'https://moviebookingsystem-production-c1f8.up.railway.app/api'
...
api.interceptors.response.use(
  ...
  (error) => {
    ...
    const skipToast = url.includes('/auth/signin') ||
...
export const ownerAPI = {
  ...
  getTheaterShows: (theaterId) => api.get(`/theater-owner/theaters/${theaterId}/shows`),
